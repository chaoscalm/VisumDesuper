...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (nightModeFlags == Configuration.UI_MODE_NIGHT_YES) {
            mapsWebView.setBackgroundColor(Color.BLACK); // Set WebView background to black in dark mode
        } else {
            mapsWebView.setBackgroundColor(Color.WHITE); // Set WebView background to white in light mode
        }
        ...
        mapsWebSettings.setUserAgentString("Mozilla/5.0 (Linux; Android 12) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.0.0 Mobile Safari/537.36");
        // Load Google Maps
